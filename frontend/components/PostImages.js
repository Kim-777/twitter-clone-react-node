...
function PostImages({ images }) {
    ...
    if (images.length === 1) {
        return (
            <>
                <img role="presentation" style={{maxHeight: '600px', objectFit: 'cover'}} src={`http://localhost:3065/${images[0].src}`} alt={images[0].src} onClick={onZoom} />
    ...
    return (        
        <>
            <div  onClick={onZoom}>
                <img role="presentation" width="50%" src={`http://localhost:3065/${images[0].src}`} alt={images[0].src} />
                <div
                    role="presentation"
